...
public class Climb extends CommandBase {
  ...
  public void execute() {
    ...
    if (Robot.m_input.testController.getBumper(Hand.kRight) == true && Robot.m_input.testController.getXButton() == true) {
      double multiplier = Robot.m_input.testController.getTriggerAxis(Hand.kRight);
      Robot.m_lift.grabMove(-multiplier);
    }
    ...
    if (Robot.m_input.testController.getBumper(Hand.kRight) == true && Robot.m_input.testController.getYButton() == true) {
      double multiplier = Robot.m_input.testController.getTriggerAxis(Hand.kRight);
      Robot.m_lift.liftMove(multiplier);
    }
